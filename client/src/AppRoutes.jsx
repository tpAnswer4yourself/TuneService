...
import MyFavoriteTracks from './components/pages/MyFavoriteTracks'
import SettingsBlock from './components/pages/SettingsBlock'
...
function AppRoutes() {
    return (
        <Routes>
            ...
            <Route path='/dashboard/my-tracks' element={<ProtectedRoute><MyFavoriteTracks /></ProtectedRoute>} />
            <Route path='/dashboard/settings' element={<ProtectedRoute><SettingsBlock /> </ProtectedRoute>} />
